...
Use this as the first message in a new Codex conversation for this project:

```text
Read `__PROJECT_ROOT__/AGENTS.md` and start this project.

First:
- follow the local project AGENTS entrypoint
